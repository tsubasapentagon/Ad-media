...
function Icon({name}:{name:IconName}){const paths:Record<IconName,ReactNode>={dashboard:<><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/></>,weekly:<><path d="M4 19V9M10 19V5M16 19v-7M22 19H2"/></>,ads:<><path d="M4 5h16v14H4zM8 9h8M8 13h5"/></>,category:<><path d="M4 4h6v6H4zM14 4h6v6h-6zM4 14h6v6H4zM14 14h6v6h-6z"/></>,log:<><path d="M12 8v5l3 2M21 12a9 9 0 1 1-3-6.7M21 4v6h-6"/></>,users:<><circle cx="9" cy="8" r="3"/><circle cx="17" cy="9" r="2"/><path d="M3 20c0-4 2-6 6-6s6 2 6 6M15 15c4 0 6 2 6 5"/></>};return <svg viewBox="0 0 24 24" aria-hidden="true">{paths[name]}</svg>}
