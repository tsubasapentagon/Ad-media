...
export async function POST(request:Request){
  ...
  try{
    ...
    if(!["category","subcategory","mapping","rename_category","rename_subcategory","delete_category","delete_subcategory"].includes(body.action??""))return Response.json({error:"操作が正しくありません"},{status:400});
