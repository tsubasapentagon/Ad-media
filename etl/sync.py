...
def main() -> None:
    ...
    print(f"広告データ更新: {start_date} 〜 {end_date}")
    result = run_pipeline(spread_init, get_ga4, start_date, end_date)
    run_id = SupabaseWriter.from_environment().save(result, start_date, end_date, trigger)
